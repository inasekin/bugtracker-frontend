  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription className="my-2">Выберите пользователя и укажите права доступа</CardDescription>
      </CardHeader>
      <CardContent>
        <form>
          ...
          <div className="flex flex-col space-y-2">
              ...
              <div className="flex flex-row space-y-2 gap-4">
                <Checkbox checked={isChecked(roleDeveloper)} onCheckedChange={() => setChecked(roleDeveloper, !isChecked(roleDeveloper))} /> <label htmlFor="terms1">{roleDeveloper}</label>
              </div>
              <div className="flex flex-row space-y-2 gap-4">
              <Checkbox checked={isChecked(roleTester)} onCheckedChange={() => setChecked(roleTester, !isChecked(roleTester))} /> <label htmlFor="terms1">{roleTester}</label>
              </div>
          </div>
        </form>
      </CardContent>
