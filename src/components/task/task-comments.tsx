        ...
        comments.forEach(comment => {
            ...
            <div key={comment.id} className="flex flex-col m-2">
                ...
                <div className="flex flex-row justify-end m-2">
                    ...
                    <Button variant={"destructive"} onClick={() => deleteCommentButton(comment.id)}>Удалить комментарий</Button>
                </div>
            </div>));
        });
    }
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <Button className="m-2" onClick={() => addComment() }>Добавить комментарий...</Button>
            </CardContent>
        </Card>
    );
};
